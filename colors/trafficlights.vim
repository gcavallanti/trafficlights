...
call s:HL('pythonInclude', 'nyellow', 'none', 'none')
call s:HL('pythonString', 'nyellow', 'none', 'none')
...
call s:HL('rubyInclude', 'ngreen', 'none', 'none')
...
call s:HL('rubyStringDelimiter', 'nyellow', 'none', 'none')
call s:HL('rubyString', 'nyellow', 'none', 'none')
call s:HL('rubySymbol', 'nblue', 'none', 'none')
call s:HL('rubyTodo', 'acontrast', 'vlcontrast', 'bold')
call s:HL('rubyPseudoVariable', 'ngreen', 'none', 'none')
call s:HL('rubyBlockParameter', 'nblue', 'none', 'none')
call s:HL('rubyInstanceVariable', 'nblue', 'none', 'none')
