...
call s:HL('StorageClass', 'nblue', 'none', 'none')

call s:HL('Structure', 'nmagenta', 'none', 'none')
...
call s:HL('cssIdentifier', 'nmagenta', 'none', 'none')
call s:HL('cssClassName', 'ngreen', 'none', 'none')
call s:HL('cssClassNameDot', 'ngreen', 'none', 'none')
...
call s:HL('htmlSpecialChar', 'nmagenta', 'none', 'none')
...
call s:HL('htmlError', 'vhcontrast', 'bred', 'none')
call s:HL('htmlString', 'nred', 'none', 'none')
...
call s:HL('pythonFunction', 'ngreen')
...
call s:HL('pythonString', 'nred', 'none', 'none')
...
call s:HL('rubyInclude', 'nyellow', 'none', 'none')
...
call s:HL('rubyStringDelimiter', 'nred', 'none', 'none')
call s:HL('rubyString', 'nred', 'none', 'none')
...
call s:HL('rubyModuleDeclaration', 'nmagenta', 'none', 'none')
call s:HL('rubyFunction', 'ngreen', 'none', 'none')
call s:HL('rubyConstant', 'nblue', 'none', 'none')
